...
<div id="tab_1" class="tab_content current">
	...
	<form class="domestic_form" action="" method="get">
		...
		<div class="quick_search_form">
			<ul style="width:100%" class="sub_left">
					<li class="overSeaCol1">
						<input type="checkbox" name="" id="checkBoxDeparture"/>
						<label for="checkBoxDeparture">한국출발</label>
						<input type="checkbox" name="" id="checkBoxDeparture2"/>
						<label for="checkBoxDeparture2">해외출발</label>					
					</li>
					<p class="ostravel_title">해외지역도시</p>
					<div class="sel_input_oscity" >
						<input type="text" id="text_search_city" placeholder="도시명을 입력해주세요"
							value="">
						<button type="submit" title="검색" class="sel_btn" >
						<i class="fa fa-search" ></i>
						</button>
					</div>
					<div class="osCloseButtom"><a>X</a></div>
			</ul>
			<!-- 국내 출발도시 셀렉트메뉴 -->
			<div class="subOsSearchBox">
				<div class="d_depart">
					<ul>
				...
				<div class="packageAdBox">
					
					<ul class="packageBox">
						<li>
							<a class="adLeft">테마여행</a>
							<a class="adRight" href="링크를 연결해주세요 ">
								테마가 있는 패키지여행 <nav class="newIcon">N</nav>
								<p>></p></a>
						</li>
					
						<li>
							<a class="adLeft">ThorWorld</a>
							<a class="adRight" href="링크를 연결해주세요 ">
								강한당신을 위한 최고급 맞춤여행 <nav class="newIcon">N</nav>
								<p>></p></a>
						</li>
					
						<li>
							<a class="adLeft">인크 특급패키지</a>
							<a class="adRight" href="링크를 연결해주세요 ">
								추천특급 패키지여행 <nav class="newIcon" style="display:none">N</nav>
								<p>></p></a>
						</li>
					</ul>
				</div>
